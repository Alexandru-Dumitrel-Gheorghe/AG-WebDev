...
import styles from "./WebdesignProzess.module.css";

export default function DesignProzess() {
  ...
  const steps = [
    {
      ...
      description:
        "Wir analysieren Ihre Marke, Zielgruppe und Wettbewerber, um ein maßgeschneidertes Designkonzept zu entwickeln, das Ihre Unternehmensziele optimal unterstützt.",
      icon: (
    ...
    },
    {
      title: "Wireframing",
      description:
        "Erstellung struktureller Wireframes, die die Benutzerführung und Informationsarchitektur Ihres zukünftigen Designs klar darstellen.",
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
          <rect
            x="3"
    ...
    },
    {
      ...
      description:
        "Entwicklung eines ansprechenden visuellen Konzepts mit Farben, Typografie und UI-Elementen, das Ihre Markenidentität perfekt widerspiegelt.",
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
          <path
    ...
    },
    {
      title: "Prototyping",
      description:
        "Erstellung interaktiver Prototypen, die das Look & Feel der finalen Website vermitteln und frühzeitiges Feedback ermöglichen.",
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
          <path
    ...
    },
    {
      ...
      description:
        "Durchführung von Usability-Tests und technischen Prüfungen zur Sicherstellung einer optimalen Benutzererfahrung auf allen Geräten.",
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
          <path
            d="M12 15L12 18"
      ...
      <div className={styles.container}>
        <motion.div className={styles.header} style={{ y: yText }}>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Eine strukturierte Herangehensweise für herausragende
            Designlösungen, die Ihre Marke optimal repräsentieren.
          </motion.p>
        </motion.div>
