...
const services = [
  {
    ...
    description:
      "Maßgeschneiderte Strategien für Ihre digitale Transformation.",
    icon: (
  ...
  },
  {
    ...
    description: "Mehr Sichtbarkeit & Reichweite durch gezielte Beratung.",
    icon: (
      <svg width="36" height="36" viewBox="0 0 24 24" fill="none">
        <circle
          cx="12"
  ...
  {
    title: "Webdesign & UX-Beratung",
    description:
      "Besseres Nutzererlebnis & ansprechendes Design für Ihre Zielgruppe.",
    icon: (
      <svg width="36" height="36" viewBox="0 0 24 24" fill="none">
        <rect
          x="7"
  ...
  },
  {
    ...
    description: "Prüfung & Optimierung Ihrer Website und Systeme.",
    icon: (
      <svg width="36" height="36" viewBox="0 0 24 24" fill="none">
        <circle
          cx="12"
  ...
  },
  {
    ...
    description: "Analyse Ihrer Wettbewerber und Marktchancen.",
    icon: (
      <svg width="36" height="36" viewBox="0 0 24 24" fill="none">
        <rect
          x="3"
  ...
  },
  {
    ...
    description: "Training und Wissensaufbau für Sie und Ihr Team.",
    icon: (
      <svg width="36" height="36" viewBox="0 0 24 24" fill="none">
        <path
      ...
      <div className={styles.header}>
        <div className={styles.headerContent}>
          ...
          <p className={styles.sectionDesc} ref={descRef}>
            Persönliche, unabhängige Beratung und digitale Strategie – für
