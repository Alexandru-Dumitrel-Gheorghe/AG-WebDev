...
import styles from "./BeratungProzess.module.css";

export default function BeratungProzess() {
  ...
  const steps = [
    {
      ...
      description:
        "Wir lernen Ihr Unternehmen kennen und definieren gemeinsam Ihre Ziele und Wünsche.",
      icon: (
    ...
    {
      title: "Analyse Ihrer Ausgangssituation",
      description:
        "Wir analysieren Ihre aktuelle Online-Präsenz, Stärken, Schwächen und Ihr Wettbewerbsumfeld.",
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
          <rect
            x="3"
    ...
    },
    {
      ...
      description:
        "Wir entwickeln eine maßgeschneiderte digitale Strategie, abgestimmt auf Ihre Ziele und Ihr Budget.",
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
          <path
    ...
    },
    {
      ...
      description:
        "Sie erhalten klare, verständliche Empfehlungen, wie Sie Ihr Ziel effizient erreichen.",
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
          <path
    ...
    },
    {
      ...
      description:
        "Wir begleiten Sie auf Wunsch bei der Umsetzung und optimieren fortlaufend Ihre digitale Strategie.",
      icon: (
        <svg width="28" height="28" viewBox="0 0 24 24" fill="none">
          <path
            d="M12 15L12 18"
      ...
      <div className={styles.container}>
        <motion.div className={styles.header} style={{ y: yText }}>
          <motion.h2
            ...
            viewport={{ once: true }}
          >
            Unser <span>Beratungsprozess</span>
          </motion.h2>
          ...
          <motion.p
            ...
            viewport={{ once: true }}
          >
            Schritt für Schritt zu Ihrer maßgeschneiderten Digitalstrategie –
