...
import styles from "./OberholzerTechStack.module.css";
        ...
        <div className={styles.header}>
          <div className={styles.headerContent}>
            ...
            <motion.p
              ...
              viewport={{ once: true }}
            >
              Für das neue Oberholzer Umzugservice Portal haben wir moderne
              Technologien, <b>UI/UX-Design</b> in Figma und ein Headless CMS
              eingesetzt – alles für maximale Ladegeschwindigkeit, Flexibilität
              und Top Google-Rankings.
            </motion.p>
          </div>
        </div>
