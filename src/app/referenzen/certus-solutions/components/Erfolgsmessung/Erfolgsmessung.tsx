...
export default function CertusErfolg() {
    ...
    <section className={styles.aboutSection} ref={sectionRef}>
      <div className={styles.topContent}>
        ...
        <div className={styles.right} ref={rightRef}>
          <p>
            ...
            Für <b>Certus Solutions</b> wurde ein innovativer Online-Auftritt
            mit Headless CMS, modernem UI/UX und dynamischem Produktkatalog
            entwickelt. <br />
            Das Ziel: Vertriebsprozesse digitalisieren, mehr Anfragen generieren
            und Top-Platzierungen bei Google sichern.
          </p>
          <a
            className={styles.button}
            href="https://certussolutions.de"
            target="_blank"
      ...
      <div className={styles.stats} ref={statsRef}>
        ...
        >
          ...
          <span className={styles.statValue}>#1 Haupt-Keyword</span>
        </div>
      </div>
    </section>
  );
