        ...
        >
          <div className={styles.quoteWrapper}>
            ...
            <motion.blockquote
              ...
              viewport={{ once: true }}
            >
              „Sehr professionelles Webdesign in Fürstenfeldbruck. Schnelle
              Umsetzung und zeitgemäßes Design. Ich bin mit meiner neuen Website
          ...
          <motion.div
            ...
            viewport={{ once: true }}
          >
            <div className={styles.authorName}>Certus Solutions</div>
            <div className={styles.authorTitle}>Paul-Cornelius Peter</div>
            <div className={styles.authorCompany}>
              Inhaber, Certus Solutions GmbH
            </div>
          </motion.div>
